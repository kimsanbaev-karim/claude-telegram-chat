...
![Диалог в теме задачи: ответ цитатой и вопрос кнопками](docs/dialog-buttons.png)

Агент отвечает цитатой на конкретное сообщение, а когда ему нужно решение — задаёт вопрос кнопками прямо в теме.
...
| `hook_stop.py` | не даёт ходу закончиться, пока сообщение из темы висит с 👀. Иначе агент дочитывает вашу реплику и молча уходит спать |
...
![Тема задачи с телефона: ролик разобран на кадры, голосовые распознаны, ответ ушёл цитатой; 👀 на сообщении означают «прочитал, работаю»](docs/video-voice.png)
